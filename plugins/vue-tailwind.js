...
const settings = {
  ...
  't-textarea': {
    ...
    props: {
      ...
      variants: {
        danger: 'border-red-300 bg-red-50 placeholder-red-200 text-red-900',
        success: 'border-green-300 bg-green-50 placeholder-gray-400 text-green-900',
        variant3: 'text-white placeholder-gray-400 bg-blue-300 '
      }
    }
  },
  't-select': {
    component: TSelect,
    props: {
      fixedClasses: 'block w-full pl-3 pr-10 py-2 transition duration-100 ease-in-out border rounded shadow-lg focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed',
      classes: 'text-black placeholder-gray-400 bg-white border-gray-300 focus:border-blue-500 ',
      variants: {
        danger: 'border-red-300 bg-red-50 placeholder-red-200 text-red-900',
        success: 'border-green-300 bg-green-50 placeholder-gray-400 text-green-900',
        variant3: 'text-white placeholder-teal-400 bg-teal-300 border-teal-700 focus:border-blue-300'
      }
    }
  },
  't-radio': {
  ...
  't-button': {
    component: TButton,
    props: {
      fixedClasses: 'block px-4 py-2 transition duration-100 ease-in-out focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed rounded-md',
      classes: 'text-white bg-blue-500 border border-transparent shadow-md ',
      variants: {
        secondary: 'text-white bg-gray-500 border border-transparent rounded shadow-md hover:bg-blue-300',
